...
public class User {
	@Rules(
			ruleList = {
					@RuleItem(id = "A",type = RuleType.not_empty,tip = "不能为空"),
					@RuleItem(id = "B",type = RuleType.number_value_limit,value = "[100,150]",tip = "不在范围之内")
			},
			logicList = {
	...
	@Rules(
			ruleList = {
					@RuleItem(id = "A",type = RuleType.not_empty,tip = "不能为空"),
					@RuleItem(id = "B",type = RuleType.number_value_limit,value = "[6,15]",tip = "不在范围之内")
			},
			logicList = {
					@LogicItem(conclusion = "A"),
					@LogicItem(conclusion = "B")
	...
	@Rules(
			ruleList = {
			@RuleItem(id = "A",type = RuleType.values_collection_limit,value = "0,1",tip = "不在范围之内"),
			@RuleItem(id = "B",type = RuleType.values_collection_limit,value = "1",tip = "身高在120厘米以上并且10到15岁之间的儿童必须参加考试"),
			@RuleItem(id = "C",type = RuleType.values_collection_limit,value = "0",tip = "身高在120厘米以下或者6到15岁之间的儿童不能参加考试")	
	},
	conditionList = {
